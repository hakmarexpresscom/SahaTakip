  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          ...
          SizedBox(height: context.dynamicHeight(0.02),),
          RichTextWidget(title: " Görev Tamamlanma Tarihi: ", text: widget.completeDate, size: 20, fontWeightTitle: FontWeight.w600, fontWeightText: FontWeight.w400, color: Colors.black, alignment: Alignment.bottomLeft,textAlign: TextAlign.start),
          SizedBox(height: context.dynamicHeight(0.02),),
          ...
          SizedBox(height: context.dynamicHeight(0.02),),
          (widget.answerNote==""||widget.answerNote==null) ? RichTextWidget(title: " Cevap Notu: ", text: "Cevap notu girilmemiş.", size: 20, fontWeightTitle: FontWeight.w600, fontWeightText: FontWeight.w400, color: Colors.black, alignment: Alignment.bottomLeft,textAlign: TextAlign.start) : RichTextWidget(title: " Cevap Notu: ", text: widget.answerNote!, size: 20, fontWeightTitle: FontWeight.w600, fontWeightText: FontWeight.w400, color: Colors.black, alignment: Alignment.bottomLeft,textAlign: TextAlign.start),
