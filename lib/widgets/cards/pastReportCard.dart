      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextWidget(text: widget.reportName, heightConst: 0, widhtConst: 0, size: 20, fontWeight: FontWeight.w500, color: Colors.black),
            SizedBox(height: context.dynamicHeight(0.02),),
            TextWidget(text: "Oluşturulma tarihi: "+widget.createDate, heightConst: 0, widhtConst: 0, size: 20, fontWeight: FontWeight.w500, color: Colors.black),
