...
class TaskCard extends StatefulWidget {
  ...
  TaskCard({Key? key, required this.taskName, required this.taskAssignmentDate, required this.taskType,required this.shop_code,required this.onTaps}): super(key: key);
