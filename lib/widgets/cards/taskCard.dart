...
class TaskCard extends StatefulWidget {
  ...
  TaskCard({Key? key, required this.heightConst,required this.widthConst, required this.taskName, required this.taskType,required this.shop_code,required this.onTaps}): super(key: key);
