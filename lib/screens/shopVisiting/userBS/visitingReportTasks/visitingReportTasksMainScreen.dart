...
class _VisitingReportTaskMainScreenState extends State<VisitingReportTaskMainScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    futureIncompleteTask = fetchIncompleteTask('http://172.23.21.112:7042/api/TamamlanmamisGorev/filterTask1?magaza_kodu=${widget.shop_code}&tamamlandi_bilgisi=0&gorev_turu=Rapor&grup_no=${groupNo}');
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index){
                    return Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        TaskCard(heightConst: 0.15, widthConst: 0.95, taskName: snapshot.data![index].taskTitle, taskAssignmentDate: snapshot.data![index].taskAssigmentDate,  taskType: snapshot.data![index].taskType , shop_code:snapshot.data![index].shopCode, onTaps: (){naviVisitingReportTaskDetailScreen(context,snapshot.data![index].task_id);}),
