                      ...
                      onTaps: (){
                        if(taskIsCompleted==false){
                          ...
                          if(photo_file.isNotEmpty){
                            updateCompleteTaskIDPhoto(box.get("photoCount"),null, snapshot.data!.shopCode, userID, null, null, "RaporCevap", photo_file, snapshot.data!.task_id, '${constUrl}api/Fotograf/${box.get("photoCount")+1}');
                          }
                          setState(() {
