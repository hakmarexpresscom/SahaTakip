...
class EnterVisitingReportScreen extends StatefulWidget {

  static var taskName = "";
  static var taskDeadline = "";
  static var taskDescription = "";

  const EnterVisitingReportScreen({super.key});

  @override
  State<EnterVisitingReportScreen> createState() =>
      _EnterVisitingReportScreenState();
}

class _EnterVisitingReportScreenState extends State<EnterVisitingReportScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('Rapor Girişi'),
        ),
        body: SingleChildScrollView(
          padding: EdgeInsets.fromLTRB(0, 0, 0, 0),
          child:Container(
            alignment: Alignment.center,
            child: enterVisitingReportScreenUI(),
          ),
        ),
  ...
  Widget addPhotoButton(){
    return ButtonWidget(text: "Fotoğraf Ekle", heightConst: 0.06, widthConst: 0.8, size: 18, radius: 20, fontWeight: FontWeight.w600, onTaps: (){}, borderWidht: 1, backgroundColor: Colors.lightGreen.withOpacity(0.6), borderColor: Colors.lightGreen.withOpacity(0.6), textColor: Colors.black);
  }
