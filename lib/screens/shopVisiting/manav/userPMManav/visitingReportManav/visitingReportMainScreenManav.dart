...
class VisitingRaportMainScreenManav extends StatefulWidget {
  ...
  VisitingRaportMainScreenManav({super.key,required this.shop_code});

  @override
  State<VisitingRaportMainScreenManav> createState() =>
      _VisitingRaportMainScreenManavState();
}

class _VisitingRaportMainScreenManavState extends State<VisitingRaportMainScreenManav> with TickerProviderStateMixin {
    ...
    return Container(
      ...
      child: Form(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
          children: <Widget>[
            TextFormFieldWidget(text: "Görev Adı", borderWidht: 2, titleColor: textColor, borderColor: Colors.black, controller: taskNameController, value: VisitingRaportMainScreenManav.taskName, paddingValue: 5,maxLines: 1,maxLength: 50,controllerString: taskNameController.text, enabled: true,),
            SizedBox(height: deviceHeight*0.02,),
            TextFormFieldDatePicker(text: "Görev Bitiş Tarihi", borderWidht: 2, titleColor: textColor, borderColor: Colors.black, dateController: taskDeadlineController, value: VisitingRaportMainScreenManav.taskDeadline, paddingValue: 5,maxLines: 1,),
            SizedBox(height: deviceHeight*0.02,),
            TextFormFieldWidget(text: "Görev Detayı", borderWidht: 2, titleColor: textColor, borderColor: Colors.black, controller: taskDescriptionController, value: VisitingRaportMainScreenManav.taskDescription, paddingValue: 5,maxLines: 8,maxLength: 500,controllerString: taskDescriptionController.text, enabled: true,),
          ],
        ),
      ),
    );
