...
class PastReportTasksScreenManav extends StatefulWidget {
  int report_id = 0;
  PastReportTasksScreenManav({super.key, required this.report_id});

  @override
  State<PastReportTasksScreenManav> createState() =>
      _PastReportTasksScreenManavState();
}

class _PastReportTasksScreenManavState extends State<PastReportTasksScreenManav> with TickerProviderStateMixin {
