...
class InPlaceTaskDetailScreenManav extends StatefulWidget {

  int task_id = 0;
  InPlaceTaskDetailScreenManav({super.key, required this.task_id});

  @override
  State<InPlaceTaskDetailScreenManav> createState() =>
      _InPlaceTaskDetailScreenManavState();
}

class _InPlaceTaskDetailScreenManavState extends State<InPlaceTaskDetailScreenManav> with TickerProviderStateMixin  {
