...
class InPlaceTaskMainScreenManav extends StatefulWidget {
  int shop_code = 0;
  InPlaceTaskMainScreenManav({super.key, required this.shop_code});

  @override
  State<InPlaceTaskMainScreenManav> createState() =>
      _InPlaceTaskMainScreenManavState();
}

class _InPlaceTaskMainScreenManavState extends State<InPlaceTaskMainScreenManav> with TickerProviderStateMixin {
