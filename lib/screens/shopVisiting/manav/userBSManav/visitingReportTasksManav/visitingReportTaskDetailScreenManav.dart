...
class VisitingReportTaskDetailScreenManav extends StatefulWidget {
  int task_id=0;
  VisitingReportTaskDetailScreenManav({super.key, required this.task_id});

  @override
  State<VisitingReportTaskDetailScreenManav> createState() =>
      _VisitingReportTaskDetailScreenManavState();
}

class _VisitingReportTaskDetailScreenManavState extends State<VisitingReportTaskDetailScreenManav> with TickerProviderStateMixin {
