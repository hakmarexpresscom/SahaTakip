...
class VisitingReportTaskDetailScreenSatisOperasyon extends StatefulWidget {
  int task_id=0;
  VisitingReportTaskDetailScreenSatisOperasyon({super.key, required this.task_id});

  @override
  State<VisitingReportTaskDetailScreenSatisOperasyon> createState() =>
      _VisitingReportTaskDetailScreenSatisOperasyonState();
}

class _VisitingReportTaskDetailScreenSatisOperasyonState extends State<VisitingReportTaskDetailScreenSatisOperasyon> with TickerProviderStateMixin {
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              ...
              naviVisitingReportTaskMainScreen(context,box.get("currentShopID"),box.get("groupNo"));
            },
          ),
        ),
                    ...
                    TaskDetailCard(
                      ...
                      onTaps: () async{
                        ...
                        if(connectivityResult[0] == ConnectivityResult.none){
                          ...
                          Navigator.of(context).pop(); // Close the dialog
                          showAlertDialogWidget(context, 'Görev Tamamlandı', 'Göreviniz başarıyla tamamlandı!', (){naviVisitingReportTaskMainScreen(context, box.get("currentShopID"),box.get("groupNo"));});
                        }
